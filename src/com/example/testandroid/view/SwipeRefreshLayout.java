...
/**
 * The SwipeRefreshLayout should be used whenever the user can loadData the
 * contents of a view via a vertical swipe gesture. The activity that
 * instantiates this view should add an OnRefreshListener to be notified
 * whenever the swipe to loadData gesture is completed. The SwipeRefreshLayout
 * will notify the listener each and every time the gesture is completed again;
 * the listener is responsible for correctly determining when to actually
 * initiate a loadData of its content. If the listener determines there should
 * not be a loadData, it must call setRefreshing(false) to cancel any visual
 * indication of a loadData. If an activity wishes to show just the progress
 ...
 * loadData of the content wherever this gesture is used.</p>
 */
...
//            }
    ...
    // Cancel the loadData gesture and animate everything back to its original state.
    ...
    /**
     * Set the listener to be notified when a loadData is triggered via the swipe
     * gesture.
     */
    ...
    /**
     * Notify the widget that loadData state has changed. Do not call this when
     * loadData is triggered by a swipe gesture.
     *
     * @param refreshing Whether or not the view should show loadData progress.
     */
    ...
    /**
     * @return Whether the SwipeRefreshWidget is actively showing loadData
     *         progress.
     */
...
//                final float yDiff = y - mInitialMotionY;
                ...
                if (mIsBeingDragged) {
                    // User velocity passed min velocity; trigger a loadData
                    if (yDiff > mDistanceToTriggerSync) {
                        // User movement passed distance; trigger a loadData
...
//        }
     ...
     * triggers a loadData should implement this interface.
     */
    ...
    public static enum Mode {
         ...
         * loadData. The start is either the Top or Left, depending on the
         * scrolling direction.
         */
        PULL_FROM_START(0x1),
         ...
         * loadData. The start is either the Bottom or Right, depending on the
         * scrolling direction.
         */
        PULL_FROM_END(0x2),

        /**
         * Allow the user to both Pull from the start, from the end to loadData.
         */
        BOTH(0x3);
