...
import com.testandroid.yang.tinker.BaseBuildInfo;
import com.testandroid.yang.tinker.BuildInfo;
...
//                Tinker.with(getApplicationContext()).cleanPatch();
        ...
        killSelfButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Toast.makeText(TestTinkerActivity.this, "注掉代码了。。。", Toast.LENGTH_SHORT).show();
...
//            Toast.makeText(context, "修复成功了哈哈2016-11-5 666", Toast.LENGTH_SHORT).show();
        } else {
